...
class UserController extends Controller
{
    ...
    public function check_create($name, $email)
    {
        ...
        $user = User::firstOrCreate(['name' => $name, 'email' => $email], ['password' => Hash::make('password')]);
    ...
    public function check_update($name, $email)
    {
        ...
        //   if not found, create a user with $name, $email and random password
        $user = NULL;
        $user  = User::where('name', $name)->updateOrCreate(['email' => $email], ['name' => $name, 'email' => $email, 'password' => Hash::make('password')]);
